...
def preprocess_opts(parser):
    ...
    group.add_argument('-train_mf', required=False, default='',
                       help="Path to the training target data")
    # Add new title and types options - Katja
    group.add_argument('-train_title', required=True,
                       help="Path to the training title data")
    group.add_argument('-train_types', required=True,
                       help="Path to the training types data")
    ...
    # Add new title and types options - Katja
    group.add_argument('-valid_title', required=True,
                       help="Path to the training title data")
    group.add_argument('-valid_types', required=True,
                       help="Path to the training types data")
...
def translate_opts(parser):
    ...
    group.add_argument('-max_length', type=int, default=500,
