...
def build_vocab(train_dataset_files, fields, data_type, share_vocab,
    ...
    if data_type == 'text':
        ...
        # Testing for title and types
        _build_field_vocab(fields["title"], counter["title"],
                           max_size=src_vocab_size,
                           min_freq=0)
        print(" * title vocab size: %d." % len(fields["title"].vocab))

        _build_field_vocab(fields["types"], counter["types"],
                           max_size=src_vocab_size,
                           min_freq=0)
        print(" * types vocab size: %d." % len(fields["types"].vocab))
