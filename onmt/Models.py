...
class GCNEncoder(EncoderBase):
    ...
    def __init__(self, embeddings,
        ...
        nn.init.xavier_normal_(self.H_2)  # Changing from nn.init.xavier_normal() as it is deprecated - Katja
        self.H_3 = torch.nn.parameter.Parameter(torch.Tensor(self.num_units, self.num_units))
        nn.init.xavier_normal_(self.H_3)  # Changing from nn.init.xavier_normal() as it is deprecated - Katja
        self.H_4 = torch.nn.parameter.Parameter(torch.Tensor(self.num_units, self.num_units))
        nn.init.xavier_normal_(self.H_4)  # Changing from nn.init.xavier_normal() as it is deprecated - Katja
